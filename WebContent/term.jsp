...
<head>
    ...
    <style>
        ...
        .agree_fr { width: 900px; white-space:pre-wrap; margin: 10px auto;  padding: 24px; border:2px solid #eee; height:600px; overflow-y:auto; font-family: 'Noto Sans KR', sans-serif; }
        .btn_fr { width: 900px; margin:10px auto; padding: 24px; }
