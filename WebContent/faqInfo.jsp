...
%>                	
                	...
                	<div class="btn">
             		<button type="button" class="in_btn1" onclick="location.href='brd.jsp#page3'">글목록으로 돌아가기</button>
             			<%if(sid.equals("admin")){%>
						<a href='faqaModify.jsp?no=<%=no %>' class="in_btn">글 수정</a>
						<a href='faqaDel.jsp?no=<%=no %>' class="in_btn">글 삭제</a>
						<% } %>
					</div>   	
                </div>
            </div>
